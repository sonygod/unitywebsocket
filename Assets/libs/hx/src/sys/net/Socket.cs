...
namespace sys.net {
	public class Socket : global::haxe.lang.HxObject {
		...
		public static object @select(global::haxe.root.Array read, global::haxe.root.Array write, global::haxe.root.Array others, object timeout) {
			unchecked {
				#line 144 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
				...
				#line 168 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
				if (( write != null )) {
					#line 168 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
					int _g1 = 0;
					#line 168 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
				...
				#line 169 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
				if (( others != null )) {
					#line 169 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
					int _g2 = 0;
					#line 169 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
				...
				#line 174 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
				...
				#line 175 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
				...
				{
					#line 180 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
					int _g7 = 0;
					#line 180 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
				...
				{
					#line 181 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
					int _g8 = 0;
					#line 181 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
		...
		public virtual void connect(global::sys.net.Host host, int port) {
			unchecked {
				...
				global::haxe.Log.trace.__hx_invoke2_o(default(double), "\u5f00\u59cb\u94fe\u63a5", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"connect", "sys.net.Socket", "sys/net/Socket.hx"}, new int[]{1981972957}, new double[]{((double) (71) )}));
				global::haxe.Log.trace.__hx_invoke2_o(default(double), host.host, default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"connect", "sys.net.Socket", "sys/net/Socket.hx"}, new int[]{1981972957}, new double[]{((double) (72) )}));
				...
				if (this.sock.Connected) {
					...
					#line 78 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
		...
		public virtual void listen(int connections) {
			#line 83 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
			this.sock.Listen(((int) (connections) ));
		}
		#line default
		
		public virtual void shutdown(bool read, bool write) {
			#line 87 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
			if (( read && write )) {
		...
		public virtual void bind(global::sys.net.Host host, int port) {
			#line 101 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
		...
		public virtual global::sys.net.Socket accept() {
			...
			#line 110 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
			return r;
		}
		#line default
		
		public virtual object peer() {
			#line 114 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
			...
			{
				#line 115 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
		...
		public virtual object host() {
			#line 119 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
			...
			{
				#line 120 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
		...
		public virtual void setTimeout(double timeout) {
			unchecked {
				#line 124 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
		...
		public virtual void waitForRead() {
			unchecked {
				...
				while (true) {
					#line 129 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
					...
					#line 130 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
		...
		public virtual void setBlocking(bool b) {
			#line 135 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"
			this.sock.Blocking = ((bool) (b) );
		}
		#line default
		
		public virtual void setFastSend(bool b) {
			#line 139 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\sys\\net\\Socket.hx"

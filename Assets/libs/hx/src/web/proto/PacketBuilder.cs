	...
	public class PacketBuilder : global::haxe.lang.HxObject {
		...
		public static global::haxe.io.Bytes createPacket(uint mainID, uint sID, int userID, global::haxe.io.Bytes data, object compress) {
			unchecked {
				...
				#line 331 "D:\\project\\sangong\\sangong\\src\\web\\proto\\PacketBuilder.hx"
		...
		public static void addBytes(global::haxe.io.Bytes bytes, global::server.IHander hander, global::haxe.lang.Function callBack) {
			unchecked {
				...
				#line 369 "D:\\project\\sangong\\sangong\\src\\web\\proto\\PacketBuilder.hx"
				...
				#line 377 "D:\\project\\sangong\\sangong\\src\\web\\proto\\PacketBuilder.hx"
				...
				while (( available >= 10 )) {
					#line 385 "D:\\project\\sangong\\sangong\\src\\web\\proto\\PacketBuilder.hx"
					int z = bi.readByte();
					int h = bi.readByte();
					...
					if ( ! (global::web.proto.PacketBuilder.checkKey(z, h, y, v1, v2, v3)) ) {
						#line 395 "D:\\project\\sangong\\sangong\\src\\web\\proto\\PacketBuilder.hx"
						global::web.proto.PacketBuilder.bytesBuff = null;
						global::haxe.Log.trace.__hx_invoke2_o(default(double), "fuck you !!! error message", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"addBytes", "web.proto.PacketBuilder", "src/web/proto/PacketBuilder.hx"}, new int[]{1981972957}, new double[]{((double) (396) )}));
						#line 397 "D:\\project\\sangong\\sangong\\src\\web\\proto\\PacketBuilder.hx"
						available = 0;
						callBack.__hx_invoke4_o(default(double), false, default(double), null, default(double), global::web.proto.Web_Error.ERROR, default(double), hander);
						#line 400 "D:\\project\\sangong\\sangong\\src\\web\\proto\\PacketBuilder.hx"
						break;
					}
					
					#line 403 "D:\\project\\sangong\\sangong\\src\\web\\proto\\PacketBuilder.hx"
					bool error = false;
					if (( packetSize <= available )) {
						...
						#line 408 "D:\\project\\sangong\\sangong\\src\\web\\proto\\PacketBuilder.hx"
						try {
							#line 409 "D:\\project\\sangong\\sangong\\src\\web\\proto\\PacketBuilder.hx"
						...
						#line 418 "D:\\project\\sangong\\sangong\\src\\web\\proto\\PacketBuilder.hx"
						available += 10;
				...
				#line 423 "D:\\project\\sangong\\sangong\\src\\web\\proto\\PacketBuilder.hx"
				global::web.proto.PacketBuilder.bytesBuff = null;
				available = 0;
				#line 426 "D:\\project\\sangong\\sangong\\src\\web\\proto\\PacketBuilder.hx"
				return;
			}
			#line default
		}

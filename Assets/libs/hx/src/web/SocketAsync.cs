	...
	public class SocketAsync : global::haxe.lang.HxObject {
						...
						if (( mid1 == 2 )) {
							#line 160 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
							{
								...
								if (( __temp_switch1 == 0 )) {
									...
									#line 344 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
									global::haxe.Log.trace.__hx_invoke2_o(default(double), "\u83b7\u53d6\u5145\u503c\u5217\u8868", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"convertDataToPacket", "web.SocketAsync", "src/web/SocketAsync.hx"}, new int[]{1981972957}, new double[]{((double) (344) )}));
									...
									#line 338 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
									global::haxe.Log.trace.__hx_invoke2_o(default(double), "\u83b7\u53d6\u8d2d\u4e70\u6e38\u620f\u5e01\u5217\u8868", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"convertDataToPacket", "web.SocketAsync", "src/web/SocketAsync.hx"}, new int[]{1981972957}, new double[]{((double) (338) )}));
									#line 340 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
								...
								else if (( __temp_switch1 == 1007 )) {
									#line 349 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
								...
								else if (( __temp_switch1 == 1008 )) {
									#line 354 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
									global::haxe.Log.trace.__hx_invoke2_o(default(double), "\u6700\u540e\u6316\u77ff\u5145\u503c\u65f6\u95f4", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"convertDataToPacket", "web.SocketAsync", "src/web/SocketAsync.hx"}, new int[]{1981972957}, new double[]{((double) (354) )}));
									global::haxe.root.Array r11 = new global::haxe.root.Array(new object[]{data});
									#line 356 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
									global::web.SocketAsync.webD.dispatchEventWithThread(new global::web.proto.ShoppingEvent(((string) ("ShoppingEvent_get_last_charge_time") ), r11, null, null, hander, null, null, null));
								}
								else if (( __temp_switch1 == 1009 )) {
									#line 359 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
									global::haxe.Log.trace.__hx_invoke2_o(default(double), "\u83b7\u53d6USDT--BCCM\u6c47\u7387", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"convertDataToPacket", "web.SocketAsync", "src/web/SocketAsync.hx"}, new int[]{1981972957}, new double[]{((double) (359) )}));
									#line 361 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
									double rate = ((double) (global::haxe.lang.Runtime.toDouble(data)) );
									global::web.proto.ShoppingEvent e1 = new global::web.proto.ShoppingEvent(((string) ("ShoppingEvent_get_rate") ), null, null, null, hander, null, null, null);
									#line 363 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
									e1.rate = rate;
									global::web.SocketAsync.webD.dispatchEventWithThread(e1);
								}
		...
		public static void installSocket(string hostAndPort, global::haxe.lang.Function onOpen, global::haxe.lang.Function onClose, global::haxe.lang.Function onError, global::haxe.lang.Function onMessage) {
			unchecked {
				...
				global::haxe.Log.trace.__hx_invoke2_o(default(double), global::haxe.lang.Runtime.concat("\u5730\u5740\u662f=   ws://", hostAndPort), default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"installSocket", "web.SocketAsync", "src/web/SocketAsync.hx"}, new int[]{1981972957}, new double[]{((double) (593) )}));
				...
				global::haxe.Log.trace.__hx_invoke2_o(default(double), "xxxx----------------", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"installSocket", "web.SocketAsync", "src/web/SocketAsync.hx"}, new int[]{1981972957}, new double[]{((double) (595) )}));
				((global::hx.ws.WebSocket) (_ws[0]) ).binaryType = ((string) ("arraybuffer") );
				#line 597 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
				((global::hx.ws.WebSocket) (_ws[0]) ).onopen = new global::web.SocketAsync_installSocket_597__Fun(onOpen);
				#line 600 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
				((global::hx.ws.WebSocket) (_ws[0]) ).onmessage = ( (( global::web.SocketAsync_installSocket_600__Fun.__hx_current != null )) ? (global::web.SocketAsync_installSocket_600__Fun.__hx_current) : (global::web.SocketAsync_installSocket_600__Fun.__hx_current = ((global::web.SocketAsync_installSocket_600__Fun) (new global::web.SocketAsync_installSocket_600__Fun()) )) );
				#line 616 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
				((global::hx.ws.WebSocket) (_ws[0]) ).onclose = new global::web.SocketAsync_installSocket_616__Fun(onClose, _ws);
				#line 622 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
				((global::hx.ws.WebSocket) (_ws[0]) ).onerror = new global::web.SocketAsync_installSocket_622__Fun(onError);
				#line 626 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
		...
		public static void sendCS(int mainID, int subID, int userID, global::haxe.io.Bytes data, object callFun) {
			unchecked {
				#line 633 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
				bool compress = false;
				#line 641 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
				global::haxe.io.Bytes data1 = global::web.proto.PacketBuilder.createPacket(((uint) (mainID) ), ((uint) (subID) ), userID, data, compress);
				#line 643 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
				if (( data1 != null )) {
					#line 644 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
					global::web.SocketAsync.socket.binaryType = ((string) ("arraybuffer") );
					#line 646 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
					global::web.SocketAsync.socket.send(data1);
				}
				else {
					#line 648 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
					global::haxe.Log.trace.__hx_invoke2_o(default(double), "send data=null", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"sendCS", "web.SocketAsync", "src/web/SocketAsync.hx"}, new int[]{1981972957}, new double[]{((double) (648) )}));
				}
				
				#line 651 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
				global::haxe.Log.trace.__hx_invoke2_o(default(double), global::haxe.lang.Runtime.concat("sendcs :", global::haxe.lang.Runtime.toString(subID)), default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"sendCS", "web.SocketAsync", "src/web/SocketAsync.hx"}, new int[]{1981972957}, new double[]{((double) (651) )}));
			}
			#line default
		}
		...
		public virtual void reConnectSocket(string hostAndPort, global::haxe.lang.Function onOpen, global::haxe.lang.Function onClose, global::haxe.lang.Function onError, global::haxe.lang.Function onmessage) {
			unchecked {
				...
				global::haxe.Timer.delay(new global::web.SocketAsync_reConnectSocket_579__Fun(onmessage, onOpen, onError, onClose, hostAndPort), 5000);
			}
			#line default
		}
...
#pragma warning disable 109, 114, 219, 429, 168, 162
namespace web {
	public class SocketAsync_reConnectSocket_579__Fun : global::haxe.lang.Function {
		
		public SocketAsync_reConnectSocket_579__Fun(global::haxe.lang.Function onmessage, global::haxe.lang.Function onOpen, global::haxe.lang.Function onError, global::haxe.lang.Function onClose, string hostAndPort) : base(0, 0) {
			#line 579 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
...
#pragma warning disable 109, 114, 219, 429, 168, 162
namespace web {
	public class SocketAsync_installSocket_597__Fun : global::haxe.lang.Function {
		
		public SocketAsync_installSocket_597__Fun(global::haxe.lang.Function onOpen) : base(0, 0) {
...
#pragma warning disable 109, 114, 219, 429, 168, 162
namespace web {
	public class SocketAsync_installSocket_600__Fun : global::haxe.lang.Function {
		
		public SocketAsync_installSocket_600__Fun() : base(1, 0) {
		}
		
		
		public static global::web.SocketAsync_installSocket_600__Fun __hx_current;
		...
		public override object __hx_invoke1_o(double __fn_float1, object __fn_dyn1) {
			unchecked {
				...
				if (( global::haxe.root.Reflect.hasField(global::haxe.lang.Runtime.getField(msg, "data", 1113806378, true), "type") && global::haxe.lang.Runtime.eq(global::haxe.lang.Runtime.getField(global::haxe.lang.Runtime.getField(msg, "data", 1113806378, true), "type", 1292432058, false), "text") )) {
					...
					global::haxe.Log.trace.__hx_invoke2_o(default(double), "\u4e0d\u63a5\u53d7text\u683c\u5f0f", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"installSocket", "web.SocketAsync", "src/web/SocketAsync.hx"}, new int[]{1981972957}, new double[]{((double) (602) )}));
					return null;
				}
				...
				object output = null;
				#line 608 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
				if (global::haxe.root.Std.isOfType(((object) (data) ), ((object) (typeof(global::hx.ws.Buffer)) ))) {
					...
					#line 611 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
					output = data;
				}
				
				#line 614 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
...
#pragma warning disable 109, 114, 219, 429, 168, 162
namespace web {
	public class SocketAsync_installSocket_616__Fun : global::haxe.lang.Function {
		
		public SocketAsync_installSocket_616__Fun(global::haxe.lang.Function onClose, global::hx.ws.WebSocket[] _ws) : base(0, 0) {
			#line 616 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
			this.onClose = onClose;
			#line 616 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
			this._ws = _ws;
		...
		public override object __hx_invoke0_o() {
			unchecked {
				...
				this._ws[0] = null;
				global::haxe.Log.trace.__hx_invoke2_o(default(double), "disconnected", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"installSocket", "web.SocketAsync", "src/web/SocketAsync.hx"}, new int[]{1981972957}, new double[]{((double) (618) )}));
...
#pragma warning disable 109, 114, 219, 429, 168, 162
namespace web {
	public class SocketAsync_installSocket_622__Fun : global::haxe.lang.Function {
		
		public SocketAsync_installSocket_622__Fun(global::haxe.lang.Function onError) : base(1, 0) {
			#line 622 "D:\\project\\sangong\\sangong\\src\\web\\SocketAsync.hx"
			this.onError = onError;
		}
		#line default

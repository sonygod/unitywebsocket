...
namespace cs.io {
	public class NativeInput : global::haxe.io.Input {
		...
		public override int readBytes(global::haxe.io.Bytes s, int pos, int len) {
			...
			int ret = 0;
			byte[] data = s.b;
			#line 59 "C:\\HaxeToolkit\\haxe\\std\\cs\\io\\NativeInput.hx"
			try {
				#line 59 "C:\\HaxeToolkit\\haxe\\std\\cs\\io\\NativeInput.hx"
				...
				#line 60 "C:\\HaxeToolkit\\haxe\\std\\cs\\io\\NativeInput.hx"
			...
			if (( ret == 0 )) {
				#line 62 "C:\\HaxeToolkit\\haxe\\std\\cs\\io\\NativeInput.hx"
				this._eof = true;
				throw global::haxe.lang.HaxeException.wrap(new global::haxe.io.Eof());
			}
		...
		public virtual void seek(int p, global::sys.io.FileSeek pos) {
			unchecked {
				#line 77 "C:\\HaxeToolkit\\haxe\\std\\cs\\io\\NativeInput.hx"
				this._eof = false;
				global::System.IO.SeekOrigin pos1 = default(global::System.IO.SeekOrigin);
				switch (pos._hx_index) {
					case 0:
					{
						#line 78 "C:\\HaxeToolkit\\haxe\\std\\cs\\io\\NativeInput.hx"
		...
		public bool eof() {
			#line 92 "C:\\HaxeToolkit\\haxe\\std\\cs\\io\\NativeInput.hx"
			return this._eof;
		}
		#line default

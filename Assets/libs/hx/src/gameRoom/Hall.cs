	...
	public class Hall : global::haxe.lang.HxObject {
		...
		public virtual void onCreateRoomC(global::web.proto.RoomEvent e) {
			unchecked {
				...
				#line 1193 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				object data = e.room;
				#line 1195 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				global::haxe.lang.Function replacer = null;
				#line 1195 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				string space = null;
				#line 1195 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				string data1 = global::haxe.format.JsonPrinter.print(((object) (data) ), replacer, space);
				#line 1197 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				global::haxe.Log.trace.__hx_invoke2_o(default(double), global::haxe.lang.Runtime.concat("onCreateRoomC", data1), default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onCreateRoomC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1197) )}));
			}
			#line default
		}
		...
		public virtual void onLoginC(global::web.proto.HallEvent e) {
			unchecked {
				...
				#line 1206 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				object player = e.player;
				global::haxe.Log.trace.__hx_invoke2_o(default(double), "\u767b\u9646\u6210\u529f", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onLoginC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1207) )}));
				#line 1208 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				global::haxe.lang.Function replacer = null;
				#line 1208 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				string space = null;
				#line 1208 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				global::haxe.Log.trace.__hx_invoke2_o(default(double), global::haxe.format.JsonPrinter.print(((object) (player) ), replacer, space), default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onLoginC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1208) )}));
				#line 1210 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
		...
		public virtual void createRoom(int userid, object data) {
			unchecked {
				...
				object tr = data;
				#line 1228 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
		...
		public virtual void onCMDResultC(global::web.proto.CMDEvent e) {
			unchecked {
				#line 86 "D:\\project\\sangong\\sangong\\src\\Comments.hx"
				//  调用系统命令回调                                                                          ;
				#line 1234 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				object cmd = e.cmd;
				#line 1236 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				switch (((int) (global::haxe.lang.Runtime.toInt((global::haxe.lang.Runtime.getField(cmd, "id", 23515, true)))) )) {
					case 4000:
					{
						#line 1241 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
						global::haxe.Log.trace.__hx_invoke2_o(default(double), "update fk bool", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onCMDResultC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1241) )}));
						#line 1241 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
						break;
					}
					...
					case 4001:
					{
						...
						global::haxe.Log.trace.__hx_invoke2_o(default(double), "update gm bool", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onCMDResultC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1244) )}));
						#line 1244 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
						break;
					}
					...
					case 4002:
					{
						#line 1238 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
						global::haxe.Log.trace.__hx_invoke2_o(default(double), "getuserinfo", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onCMDResultC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1238) )}));
						#line 1238 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
						break;
					}
					...
					case 4003:
					{
						#line 1247 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
						global::haxe.Log.trace.__hx_invoke2_o(default(double), "update gailv bool", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onCMDResultC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1247) )}));
						#line 1247 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
						break;
					}
		...
		public virtual void onGET_ROOM_INFOC(global::web.proto.RoomEvent e) {
			unchecked {
				...
				global::haxe.Log.trace.__hx_invoke2_o(default(double), "\u83b7\u53d6\u623f\u95f4\u4fe1\u606f", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onGET_ROOM_INFOC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1252) )}));

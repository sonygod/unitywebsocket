	...
	public class Hall : global::haxe.lang.HxObject {
		...
		protected static void __hx_ctor_gameRoom_Hall(global::gameRoom.Hall __hx_this) {
			unchecked {
				...
				#line 64 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				{
					#line 65 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
		...
		public virtual void onCreateRoomC(global::web.proto.RoomEvent e) {
			unchecked {
				...
				#line 1049 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				object data = e.room;
				#line 1051 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				global::haxe.lang.Function replacer = null;
				#line 1051 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				string space = null;
				#line 1051 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				string data1 = global::haxe.format.JsonPrinter.print(((object) (data) ), replacer, space);
				#line 1053 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				global::haxe.Log.trace.__hx_invoke2_o(default(double), global::haxe.lang.Runtime.concat("onCreateRoomC", data1), default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onCreateRoomC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1053) )}));
			}
			#line default
		}
		...
		public virtual void onLoginC(global::web.proto.HallEvent e) {
			unchecked {
				...
				global::haxe.Log.trace.__hx_invoke2_o(default(double), "\u767b\u9646\u6210\u529f", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onLoginC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1063) )}));
				#line 1064 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				global::haxe.lang.Function replacer = null;
				#line 1064 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				string space = null;
				#line 1064 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				global::haxe.Log.trace.__hx_invoke2_o(default(double), global::haxe.format.JsonPrinter.print(((object) (player) ), replacer, space), default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onLoginC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1064) )}));
		...
		public virtual void createRoom(int userid, object data) {
			unchecked {
				...
				#line 1082 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				object tr = data;
		...
		public virtual void onCMDResultC(global::web.proto.CMDEvent e) {
			unchecked {
				#line 86 "D:\\project\\sangong\\sangong\\src\\Comments.hx"
				//  调用系统命令回调                                                                          ;
				#line 1090 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				object cmd = e.cmd;
				...
				switch (((int) (global::haxe.lang.Runtime.toInt((global::haxe.lang.Runtime.getField(cmd, "id", 23515, true)))) )) {
					case 4000:
					{
						#line 1097 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
						global::haxe.Log.trace.__hx_invoke2_o(default(double), "update fk bool", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onCMDResultC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1097) )}));
						#line 1097 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
						break;
					}
					...
					case 4001:
					{
						#line 1100 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
						global::haxe.Log.trace.__hx_invoke2_o(default(double), "update gm bool", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onCMDResultC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1100) )}));
						#line 1100 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
						break;
					}
					...
					case 4002:
					{
						...
						global::haxe.Log.trace.__hx_invoke2_o(default(double), "getuserinfo", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onCMDResultC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1094) )}));
						#line 1094 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
						break;
					}
					...
					case 4003:
					{
						#line 1103 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
						global::haxe.Log.trace.__hx_invoke2_o(default(double), "update gailv bool", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onCMDResultC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1103) )}));
						#line 1103 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
						break;
					}
		...
		public virtual void onGET_ROOM_INFOC(global::web.proto.RoomEvent e) {
			unchecked {
				#line 1108 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				global::haxe.Log.trace.__hx_invoke2_o(default(double), "\u83b7\u53d6\u623f\u95f4\u4fe1\u606f", default(double), new global::haxe.lang.DynamicObject(new int[]{302979532, 1547539107, 1648581351}, new object[]{"onGET_ROOM_INFOC", "gameRoom.Hall", "src/gameRoom/Hall.hx"}, new int[]{1981972957}, new double[]{((double) (1108) )}));
				#line 1110 "D:\\project\\sangong\\sangong\\src\\gameRoom\\Hall.hx"
				object info = e.room;
			}
			#line default
		}

...
namespace utils {
	public class SQLRex : global::haxe.lang.HxObject {
		...
		public SQLRex() {
			#line 3 "C:\\projects\\BCGAME\\sangong\\src\\utils\\SQLRex.hx"
		...
		public static bool checkSQL(string content) {
			unchecked {
				#line 14 "C:\\projects\\BCGAME\\sangong\\src\\utils\\SQLRex.hx"
				if (( content == null )) {
					#line 15 "C:\\projects\\BCGAME\\sangong\\src\\utils\\SQLRex.hx"
					return false;
				}
				
				#line 20 "C:\\projects\\BCGAME\\sangong\\src\\utils\\SQLRex.hx"
				global::haxe.root.EReg r = new global::haxe.root.EReg("(delete)|(drop)|(;)|(--)|(insert)|(drop)|(count)|(\\*)|(select)|(where)|(when)|(\\s+)|(\\()|(\\))|(\")|(0x)|(,)|(offset)|(<)|(>)|(=)|(&)|(\\|)|(ike)|(%)|(!)|(CHAR)|(#)", "");
				#line 22 "C:\\projects\\BCGAME\\sangong\\src\\utils\\SQLRex.hx"
				bool result = r.match(content);
				#line 24 "C:\\projects\\BCGAME\\sangong\\src\\utils\\SQLRex.hx"
				if (result) {
					#line 25 "C:\\projects\\BCGAME\\sangong\\src\\utils\\SQLRex.hx"
				...
				#line 27 "C:\\projects\\BCGAME\\sangong\\src\\utils\\SQLRex.hx"
				return result;
			}
			#line default
		}

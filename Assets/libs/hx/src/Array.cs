...
namespace haxe.root {
	public sealed class Array : global::haxe.lang.HxObject {
		...
		public global::haxe.iterators.ArrayIterator iterator() {
			#line 419 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			return new global::haxe.iterators.ArrayIterator(((global::haxe.root.Array) (this) ));
		}
		#line default
		...
		public override object __hx_invokeField(string field, int hash, object[] dynargs) {
			unchecked {
				...
				switch (hash) {
					...
					{
						#line 28 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
						return this.slice(((int) (global::haxe.lang.Runtime.toInt(((object) (dynargs[0]) ))) ), ( (( dynargs.Length > 1 )) ? (((object) (dynargs[1]) )) : (null) ));
					}

		...
		public override object __hx_invokeField(string field, int hash, object[] dynargs) {
			unchecked {
				...
				switch (hash) {
					...
					{
						#line 28 "C:\\HaxeToolkit\\haxe\\std\\cs\\_std\\EReg.hx"
						return this.matchSub(global::haxe.lang.Runtime.toString(((object) (dynargs[0]) )), ((int) (global::haxe.lang.Runtime.toInt(((object) (dynargs[1]) ))) ), ( (( dynargs.Length > 2 )) ? (((object) (dynargs[2]) )) : (null) ));
					}

...
namespace server {
	public sealed class SocketEvent : global::openfl.events.Event {
		...
		static SocketEvent() {
			#line 14 "C:\\projects\\BCGAME\\sangong\\src\\server\\SocketEvent.hx"
			global::server.SocketEvent.OPEN = ((string) ("socket_open") );
			#line 19 "C:\\projects\\BCGAME\\sangong\\src\\server\\SocketEvent.hx"
			global::server.SocketEvent.CLOSE = ((string) ("socket_close") );
			#line 24 "C:\\projects\\BCGAME\\sangong\\src\\server\\SocketEvent.hx"
			global::server.SocketEvent.MESSAGE = ((string) ("socket_message") );
			#line 27 "C:\\projects\\BCGAME\\sangong\\src\\server\\SocketEvent.hx"
			global::server.SocketEvent.ERROR = ((string) ("socket_error") );
			#line 29 "C:\\projects\\BCGAME\\sangong\\src\\server\\SocketEvent.hx"
		...
		public SocketEvent(string type, global::server.IHander hander, object bubbles, object cancelable) : base(global::haxe.lang.EmptyObject.EMPTY) {
			#line 38 "C:\\projects\\BCGAME\\sangong\\src\\server\\SocketEvent.hx"
		...
		private static void __hx_ctor_server_SocketEvent(global::server.SocketEvent __hx_this, string type, global::server.IHander hander, object bubbles, object cancelable) {
			#line 37 "C:\\projects\\BCGAME\\sangong\\src\\server\\SocketEvent.hx"
			...
			#line 40 "C:\\projects\\BCGAME\\sangong\\src\\server\\SocketEvent.hx"
		...
		public override global::openfl.events.Event clone() {
			#line 45 "C:\\projects\\BCGAME\\sangong\\src\\server\\SocketEvent.hx"
			global::server.SocketEvent @event = new global::server.SocketEvent(this.type, this.hander, this.bubbles, this.cancelable);
			@event.target = this.target;
			#line 47 "C:\\projects\\BCGAME\\sangong\\src\\server\\SocketEvent.hx"
			@event.currentTarget = this.currentTarget;
			@event.eventPhase = this.eventPhase;
			#line 49 "C:\\projects\\BCGAME\\sangong\\src\\server\\SocketEvent.hx"
		...
		public override object __hx_setField(string field, int hash, object @value, bool handleProperties) {
			unchecked {
				#line 9 "C:\\projects\\BCGAME\\sangong\\src\\server\\SocketEvent.hx"
				switch (hash) {
					case 939359644:
					{
						#line 9 "C:\\projects\\BCGAME\\sangong\\src\\server\\SocketEvent.hx"

...
namespace hx.ws {
	public class WebSocket : global::hx.ws.WebSocketCommon {
		...
		public WebSocket(string uri) : base(((global::haxe.lang.EmptyObject) (global::haxe.lang.EmptyObject.EMPTY) )) {
			#line 143 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
		...
		protected static void __hx_ctor_hx_ws_WebSocket(global::hx.ws.WebSocket __hx_this, string uri) {
			unchecked {
				#line 122 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
				__hx_this._encodedKey = "wskey";
				#line 121 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
				__hx_this._key = "wskey";
				#line 126 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
				{
					#line 127 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					global::haxe.root.EReg uriRegExp = new global::haxe.root.EReg("^(\\w+?)://([\\w\\.-]+)(:(\\d+))?(/.*)?$", "");
					#line 129 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					if ( ! (uriRegExp.match(uri)) ) {
						#line 130 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					...
					#line 132 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					string proto = uriRegExp.matched(1);
					if (( proto == "wss" )) {
						#line 135 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
						throw global::haxe.lang.HaxeException.wrap("Secure sockets not implemented");
					}
					else if (( proto == "ws" )) {
						#line 142 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
						__hx_this._port = 80;
						global::hx.ws.WebSocketCommon.__hx_ctor_hx_ws_WebSocketCommon(__hx_this, null);
					}
					else {
						#line 145 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
						throw global::haxe.lang.HaxeException.wrap(global::haxe.lang.Runtime.concat("Unknown protocol ", proto));
					}
					
					#line 148 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					__hx_this._host = uriRegExp.matched(2);
					object parsedPort = global::haxe.root.Std.parseInt(uriRegExp.matched(4));
					#line 150 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					if (( ((int) (global::haxe.lang.Runtime.toInt(parsedPort)) ) > 0 )) {
						#line 151 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
						__hx_this._port = ((int) (global::haxe.lang.Runtime.toInt(parsedPort)) );
					}
					
					#line 153 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					__hx_this._uri = uriRegExp.matched(5);
					if (( ( __hx_this._uri == null ) || ( __hx_this._uri.Length == 0 ) )) {
						#line 155 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
						__hx_this._uri = "/";
					}
					
					#line 157 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					__hx_this._socket.setBlocking(true);
					#line 159 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					__hx_this._socket.connect(new global::sys.net.Host(((string) (__hx_this._host) )), __hx_this._port);
					#line 162 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					__hx_this._socket.setBlocking(false);
					#line 181 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					...
					#line 191 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
		...
		public virtual void processThread() {
			unchecked {
				#line 195 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
				...
				#line 197 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
				while (( ws.state != global::hx.ws.State.Closed )) {
					#line 198 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					ws.process();
					global::System.Threading.Thread.Sleep(((int) (10) ));
				}
				
				#line 201 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
		...
		public virtual void sendHandshake() {
			#line 205 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
			global::hx.ws.HttpRequest httpRequest = new global::hx.ws.HttpRequest();
			httpRequest.method = "GET";
			#line 207 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
			httpRequest.uri = this._uri;
			#line 209 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
			...
			#line 211 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
			...
			#line 213 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
			...
			#line 215 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
			...
			#line 217 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
			...
			#line 220 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
		...
		public override void handleData() {
			#line 225 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
			if (( this.state._hx_index == 0 )) {
				#line 227 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
				global::hx.ws.HttpResponse httpResponse = this.recvHttpResponse();
				if (( httpResponse == null )) {
					#line 229 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					return;
				}
				
				#line 231 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
				this.handshake(httpResponse);
				this.handleData();
			}
			else {
				#line 234 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
				base.handleData();
			}
		...
		public virtual void handshake(global::hx.ws.HttpResponse httpResponse) {
			unchecked {
				#line 239 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
				...
				if (( httpResponse.code != 101 )) {
					#line 241 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					if (( this.onerror != null )) {
						#line 242 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					...
					#line 244 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					this.close();
					return;
				}
				
				#line 247 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
				...
				if (( secKey != global::haxe.crypto.Base64.encode(global::haxe.crypto.Sha1.make(global::haxe.io.Bytes.ofString(global::haxe.lang.Runtime.concat(this._encodedKey, "258EAFA5-E914-47DA-95CA-C5AB0DC85B11"), null)), null) )) {
					#line 249 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					if (( this.onerror != null )) {
						#line 250 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
						this.onerror.__hx_invoke1_o(default(double), "Error during WebSocket handshake: Incorrect \'Sec-WebSocket-Accept\' header value");
					}
					
					#line 252 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					this.close();
					return;
				}
				
				#line 255 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
		...
		public override double __hx_setField_f(string field, int hash, double @value, bool handleProperties) {
			unchecked {
				#line 115 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
				switch (hash) {
					case 2104336224:
					{
						#line 115 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
...
namespace hx.ws {
	public class WebSocket___hx_ctor_hx_ws_WebSocket_182__Fun : global::haxe.lang.Function {
		...
		public WebSocket___hx_ctor_hx_ws_WebSocket_182__Fun(global::hx.ws.WebSocket ws) : base(0, 0) {
			#line 182 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
			this.ws = ws;
		}
		#line default
		...
		public override object __hx_invoke0_o() {
			unchecked {
				#line 183 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
				...
				while (( this.ws.state != global::hx.ws.State.Closed )) {
					#line 185 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"
					this.ws.process();
					global::System.Threading.Thread.Sleep(((int) (10) ));
				}
				
				#line 188 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\WebSocket.hx"

...
namespace hx.ws {
	public sealed class State_Handshake : global::hx.ws.State {
		...
		public override string getTag() {
			#line 4 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\State.hx"
			return "Handshake";
		}
		#line default
...
namespace hx.ws {
	public sealed class State_Head : global::hx.ws.State {
		...
		public override string getTag() {
			#line 5 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\State.hx"
			return "Head";
		}
		#line default
...
namespace hx.ws {
	public sealed class State_HeadExtraLength : global::hx.ws.State {
		...
		public override string getTag() {
			#line 6 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\State.hx"
...
namespace hx.ws {
	public sealed class State_HeadExtraMask : global::hx.ws.State {
		...
		public override string getTag() {
			#line 7 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\State.hx"
...
namespace hx.ws {
	public sealed class State_Body : global::hx.ws.State {
		...
		public override string getTag() {
			#line 8 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\State.hx"
			return "Body";
		}
		#line default
...
namespace hx.ws {
	public sealed class State_Closed : global::hx.ws.State {
		...
		public override string getTag() {
			#line 9 "C:\\projects\\BCGAME\\sangong\\src\\hx\\ws\\State.hx"
			return "Closed";
		}
		#line default
